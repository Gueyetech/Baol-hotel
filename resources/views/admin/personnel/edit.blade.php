<x-admin>
    ...
    <div class=" h-full ">
        <div class="mx-auto max-w-3xl shadow-xl px-6 py-6 bg-white border-0  sm:rounded-sm">
            ...
            <form action="{{ route('admin.personnel.update', $personnel) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('get')

                <div class="relative z-0 w-full mb-5 text-center justify-center">
                    <div class=" mx-auto  max-w-64 gap-4 items-center w-fit ">
                        <img src="{{ asset($personnel->user->image) }}" alt="Image de profil"
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input type="text" name="nom" placeholder=""
                            value="{{ old('nom', $personnel->user->nom) }}"
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <select name="genre"
                            ...
                            <option @if ($personnel->user->genre == 'Fiminin') selected @endif value="Fiminin">Fiminin</option>
                            <option @if ($personnel->user->genre == 'Masculin') selected @endif value="Masculin">Masculin</option>
                        </select>
                        <label for="genre"
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input type="text" name="adresse" placeholder=""
                            value="{{ old('adresse', $personnel->user->adresse) }}"
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input type="text" name="tel" placeholder=""
                            value="{{ old('tel', $personnel->user->tel) }}"
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <select name="role"
                            ...
                            @foreach ($roles as $role)
                                <option value="{{ $role->id }}" @if ($role->id == $personnel->user->role_id) selected @endif>
                                    {{ $role->role }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input type="text" name="service" placeholder=""
                            value="{{ old('service', $personnel->service) }}"
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
