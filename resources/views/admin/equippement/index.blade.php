<x-admin>
    ...
    @section('title', 'Liste des équippements')

    <div class="justify-center h-full">
        <div class=" w-full mx-auto bg-white">
            <header class="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
                <h5>@yield('title')</h5>
                <a href="{{ route('admin.equippement.create') }}" class="text-sm bg-[#c9ba46]  px-4 py-2 text-black font-bold">Ajouter</a>
            </header>
            @include('components.toast')
            <div class="p-2">
                <form action="{{ route('admin.equippement.recherche') }}" method="POST"
                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full mb-3">
                        ...
                        <tbody class="text-sm divide-y divide-gray-100">
                            ...
                            @forelse ($equippements as $equippement)
                                <tr class="hover:bg-[#f9f9ed]">
                                    ...
                                    <td class="p-3 whitespace-nowrap ">
                                        <div class="text-end flex gap-2 justify-end">
                                            <a href="{{ route('admin.equippement.edit', $equippement) }}"
                                            ...
                                            <form action="{{ route('admin.equippement.destroy', $equippement) }}"
                                                method="post">
                                                @csrf
                                                @method('delete')
                                                <button class="btn ">
                            ...
                            @empty
                                <tr>
                                    <td class="p-3 whitespace-nowrap">
                                        <div class="text-center">Aucun equippement</div>
                                    </td>
