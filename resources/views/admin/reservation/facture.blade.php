<x-admin>
    ...
    <div class="sm:mb-4">
        <a href="{{ route('admin.reservation.show', ['reservation' => $reservation]) }}"
    ...
    <div id="facture" class="flex items-center justify-center overflow-x-auto ">

        <div class="max-w-5xl p-2 bg-white shadow-lg">
            <div class="flex justify-between pt-4 px-2">
                <div class="">
                    <h1
                        class="text-sm sm:text-xl md:text-2xl xl:text-3xl lg:text-3xl italic font-extrabold tracking-widest text-black">
                        BAOL HOTEL</h1>
                </div>
                <div class="p-2">
                    <ul class="flex">
                ...
                <div>
                    ...
                    <h6 class="font-semibold">Personne(s) :
                        <span class="text-sm font-medium">
                            @if ($reservation->adulte != null)
                                {{ $reservation->adulte }} adulte(s)
                                @if ($reservation->enfant != null)
                                    , {{ $reservation->enfant }} enfant(s)
                                @endif
                            @else
            ...
            <div class="flex justify-end p-4">
                ...
                <div class="p-4">
                    <h3>Signature</h3>
                    <div class="text-2xl italic text-indigo-500">Baol hotel</div>
                </div>
            </div>
