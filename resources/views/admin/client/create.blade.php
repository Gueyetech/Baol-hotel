<x-admin>
    ...
    <div class=" h-full ">
        <div class="mx-auto max-w-3xl shadow-xl px-6 py-6 bg-white border-0  sm:rounded-sm">
            ...
            <form action="{{ route('admin.client.store', $client) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input type="text" name="ville" placeholder="" value="{{ old('ville') }}"
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input type="text" name="pays" placeholder="" value="{{ old('pays') }}"
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
