            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('admin.index') }}" class="block text-white h-9 w-auto fill-current" >
                            BAOL HOTEL
                        </a>
                    </div>
                </div>
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('admin.index') }}"
                        class="flex ms-3 @if (Route::is('admin.index'))
                        bg-[#66bfff] text-[#06284b] @else dark:hover:bg-gray-700 text-gray-900 @endif  items-center p-2   dark:text-white  hover:bg-[#66bfff] hover:text-[#352513]  group">
                        Tableau de bord
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('admin.reservation.index') }}"
                        class="flex ms-3 @if (Route::is(['admin.reservation.index', 'admin.reservation.show'])) bg-[#33acfd] text-[#352513] @else dark:hover:bg-gray-700 text-gray-900 @endif  items-center p-2   dark:text-white  hover:bg-[#c9ba46] hover:text-[#352513]  group">
                        Réservations
                    </a>
                </li>
