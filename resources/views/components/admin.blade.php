...
<body class="font-sans antialiased bg-[#f5f5dc] ">
    <nav class="fixed top-0 z-50 w-full  border-b-2 border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="px-3 py-3 lg:px-5 bg-[#a0852e] lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('admin.index') }}" class="text-xl text-black font-bold">
                            BAOL <spam class="text-xl text-[#f9f9ed]">HOTEL</spam>
                        </a>
                    </div>
                </div>
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('admin.index') }}"
                        class="flex ms-3 @if (Route::is('admin.index')) bg-[#a0852e] text-[#f9f9ed] @else text-[#352513] @endif  items-center p-2   dark:text-white  hover:bg-[#baa538] hover:text-[#f9f9ed]  group">
                        Tableau de bord
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.calendrier') }}"
                        class="flex ms-3 @if (Route::is(['admin.calendrier'])) bg-[#a0852e] text-[#f9f9ed] @else text-[#352513] @endif  items-center p-2   dark:text-white  hover:bg-[#baa538] hover:text-[#f9f9ed]  group">
                        Calendrier
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.reservation.index') }}"
                        class="flex ms-3 @if (Route::is([
                                ...
                                'admin.reservation.recherche',
                                'admin.reservation.filtre',
                                'admin.reservation.store',
                                'admin.reservation.showFormClient',
                                'admin.facture.show',
                                'admin.reservation.show',
                                'admin.reservation.createClient',
                                'admin.facture.show',
                                'admin.facture.ajouterServiceForm',
                            ])) bg-[#a0852e] text-[#f9f9ed] @else text-[#352513] @endif  items-center p-2   dark:text-white  hover:bg-[#baa538] hover:text-[#f9f9ed]  group">
                        Réservations
                    </a>
                </li>
                <li>
                    ...
                    <a href="{{ route('admin.chambre.index') }}"
                        class="flex ms-3 @if (Route::is([
                                'admin.chambre.index',
                                'admin.chambre.recherche',
                                'admin.chambre.create',
                                'admin.chambre.store',
                                'admin.chambre.edit',
                                'admin.chambre.update',
                            ])) bg-[#a0852e] text-[#f9f9ed] @else text-[#352513] @endif  items-center p-2   dark:text-white  hover:bg-[#baa538] hover:text-[#f9f9ed]  group">
                        Chambres
                    </a>
                </li>
                    ...
                    <li>
                        <a href="{{ route('admin.equippement.index') }}"
                            class="flex ms-3 @if (Route::is([
                                    ...
                                    'admin.equippement.recherche',
                                    'admin.equippement.create',
                                    'admin.equippement.store',
                                    'admin.equippement.edit',
                                    'admin.equippement.update',
                                ])) bg-[#a0852e] text-[#f9f9ed] @else text-[#352513] @endif  items-center p-2   dark:text-white  hover:bg-[#baa538] hover:text-[#f9f9ed]  group">
                            Equipements
                        </a>
                    </li>
